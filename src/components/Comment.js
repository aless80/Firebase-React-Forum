                ...
                >
                  ...
                  <tbody>
                    <tr className="align-top">
                      <td className={"alt" + this.remainderTo2(this.props.comment.id) + " border"} width="175">
                      ...
                      <td className={"alt" + this.remainderTo2(this.props.comment.id) + " border"} id={"td_post_"+this.props.comment.id}>
